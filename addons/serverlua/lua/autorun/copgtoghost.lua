...
list.Set( "simfphys_lights", "copgtoghost", light_table)

local V = {
	Name = "Pontiac GTO Undercover",
	Model = "models/nfs_gto_undercover/nfs_gto_undercover.mdl",
...
if (file.Exists( "models/nfs_gto_undercover/nfs_gto_undercover.mdl", "GAME" )) then
	list.Set( "simfphys_vehicles", "copgtoghost", V )
end